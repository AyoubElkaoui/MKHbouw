        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-zinc-500 leading-relaxed mb-6 text-sm">
              Specialist in totale afbouw en renovatie. Actief door heel Nederland voor particulieren en bedrijven.
            </p>
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-white/5 hover:bg-primary flex items-center justify-center transition-all hover:-translate-y-0.5 border border-white/5 hover:border-primary"
              >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="group flex items-center gap-1 text-zinc-500 hover:text-white transition-colors text-sm"
                  >
                    {link.label}
                    <ArrowUpRight
                      size={12}
          ...
          <div>
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-zinc-600 text-xs mb-0.5">Bel ons</p>
                  <a
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-zinc-600 text-xs mb-0.5">Email ons</p>
                  <a
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-zinc-600 text-xs mb-0.5">Locatie</p>
