...
export default function SchuurwerkPage() {
  const benefits = [
    "Stofvrij schuren met professionele apparatuur en afzuigsystemen",
    "Perfecte voorbereiding voor schilderwerk of stucwerk",
    "Verwijdering van oude verflagen en oneffenheden",
    "Egaliseren van oneffen oppervlakken voor optimaal resultaat",
    "Geschikt voor hout, stuc, beton en andere materialen",
    "Snelle en efficiënte uitvoering met minimale overlast",
  ];

  const applications = [
    "Houten kozijnen en deuren",
    "Plafonds en wanden",
    "Betonnen oppervlakken",
    "Stucwerk en sierpleister",
    "Vloeren (houten en betonnen)",
    "Meubilair en binnenwerk",
  ];

  const whyUs = [
    {
      title: "Stofvrij werken",
      desc: "Met professionele stofzuigers en afzuigsystemen blijft uw ruimte schoon tijdens het werk",
    },
    {
      title: "Ervaren vakmensen",
      desc: "Onze medewerkers hebben ruime ervaring in schuurwerk en kennen alle technieken",
    },
    {
      title: "Kwaliteitsgarantie",
      desc: "Wij garanderen een perfect voorbereid oppervlak voor een duurzaam eindresultaat",
    },
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="relative min-h-[70vh] flex items-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-32 pb-20 lg:pt-40 lg:pb-28">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <span className="relative">
                  <span className="relative z-10">Schuurwerk</span>
              ...
              >
                Stofvrij schuren voor perfecte voorbereiding van uw schilder- en
                stucwerk projecten door heel Nederland. Vakkundig uitgevoerd
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                ...
                >
                  ...
                  <h2 className="text-4xl md:text-5xl font-extrabold mt-3 mb-6 text-gray-900">
                    De basis voor perfect resultaat
                  </h2>
                  <p className="text-xl text-gray-700 leading-relaxed mb-6">
                    Professioneel schuurwerk is essentieel voor een perfecte
                    afwerking van schilder- en stucwerk. MKH Bouw werkt met
                    moderne stofzuigerssystemen die ervoor zorgen dat uw ruimte
                    schoon blijft tijdens het werk. Geen stofwolken, geen vieze
                    rommel.
                  </p>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    Of het nu gaat om het voorbereiden van wanden voor een
                    nieuwe verflaag, het egaliseren van oneffen oppervlakken, of
                    het schuren van houten kozijnen, wij leveren kwaliteit die
                    het verschil maakt in het eindresultaat. Onze ervaring en
                    moderne apparatuur garanderen perfectie.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    Voor bedrijven bieden wij onderhoudscontracten waarin
                    regulier schuurwerk is opgenomen. Gevestigd in Amsterdam,
                    actief landelijk. Ideaal voor kantoorpanden, winkels en
                    horeca waar regelmatig onderhoud nodig is zonder overlast
                    voor uw bedrijf.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                    <Image
                      src="https://images.unsplash.com/photo-1631679706909-1844bbd07221?q=80&w=2670&auto=format&fit=crop"
                      alt="Professioneel schuurwerk MKH Bouw Amsterdam"
                      width={600}
                      height={500}
              ...
              >
                <div className="text-center mb-12">
                  ...
                  <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mt-3 mb-4">
                    Waarom professioneel schuurwerk?
                  </h2>
              ...
              >
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    Schuurwerk voor diverse materialen en oppervlakken
                  </p>
                </div>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {applications.map((app, index) => (
                    <div
                      key={index}
                      className="group bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all border border-slate-100 hover:border-accent/20 relative overflow-hidden"
                    >
              ...
              >
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {whyUs.map((item, index) => (
                    <div
                      key={index}
                      className="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all border border-slate-100 hover:border-primary/20 text-center relative overflow-hidden"
                    >
                      {/* Subtle top border accent */}
                      <div className="absolute top-0 left-6 right-6 h-0.5 bg-gradient-to-r from-primary to-accent rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
              ...
              >
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    Systematisch en professioneel voor het beste resultaat
                  </p>
                </div>
                  ...
                  {[
                    {
                      step: "1",
                      title: "Inspectie",
                      desc: "Beoordeling van het oppervlak",
                    },
                    {
                      step: "2",
                      title: "Voorbereiding",
                      desc: "Afplakken en beschermen van ruimte",
                    },
                    {
                      step: "3",
                      title: "Schuren",
                      desc: "Vakkundig schuren met stofafzuiging",
                    },
                    {
                      step: "4",
                      title: "Oplevering",
                      desc: "Schone oplevering, klaar voor vervolg",
                    },
                  ].map((item, index) => (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                aan voor uw project. Ervaren vakmanschap, eerlijke prijzen.
              </motion.p>
