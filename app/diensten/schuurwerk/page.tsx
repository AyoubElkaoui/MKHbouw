          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 mb-6 leading-tight">
                Professioneel <span className="text-primary">Schuurwerk</span>
              </h1>
              ...
              >
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {whyUs.map((item, index) => (
                    <div
                      key={index}
                      className="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all border border-slate-100 text-center relative overflow-hidden"
                    >
